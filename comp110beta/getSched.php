...
//gives the access token to the GitHub API for authorization
 curl_setopt($curl,CURLOPT_URL,'https://api.github.com/repos/comp110/KarenBot/contents/data/spring-17/staff/'.$onyen.'.csv?access_token=435e158a0a980c180ea2b53621d6bf5077da6147');
