...
$(document).ready(function() {
    ...
    //TODO: Fix bug when moving a date over another date
...
//deletes dates, removes from array
    var deleteEvent = function(event, jsEvent, view) {
     // alert(event._id);
            ...
            for(var i = startDate.getHours(); i < endDate.getHours(); i++){
...
//get rid of default title
  ...
  $("textarea#onyen").on('keyup paste', function() {
    var string = "";
